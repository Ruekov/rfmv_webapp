...
export class GamesSystem extends Component {
    ...
    constructor(props) {
        ...
        this.state = { games: [], loading: true, Input: params.SystemID, SystemID: params.SystemID.replaceAll("-", " ") };
    }
    ...
    async populateGamesData() {
        ...
        axios.get('http://rfmv.hypercompumega.net/api/games/?platform='+this.state.Input).then(response => {
