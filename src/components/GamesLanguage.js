...
export class GamesLanguage extends Component {
    ...
    constructor(props) {
        ...
        this.state = { games: [], loading: true, Input: params.LangID, LangID: params.LangID.replaceAll("-", " ") };
    }
    ...
    async populateGamesData() {
        ...
        axios.get('http://rfmv.hypercompumega.net/api/games/?language='+this.state.Input).then(response => {
